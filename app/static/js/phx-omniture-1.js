...
var basePage = "azcentral.com : comics"; //STEP 1: Update the base page name i.e. azcentral.com : /top hawaiian

s.pageName= basePage; 
s.prop7  = s.pageName;
s.prop8 = "www.azcentral.com";
s.prop17 = "life";
s.prop18 = "comics";
s.prop19 = "front";
s.prop23 = "http://archive.azcentral.com/thingstodo/comics/";
s.prop24 = 'azcentral.com';
s.prop25 = s_account;
...
s.trackingServer=s_account+".112.2o7.net";


function OmnitureSendPageLoad(){
    s.prop6 = s.prop17+":"+s.prop18+":"+s.prop19;   
    s.pageName = basePage+window.parent.location.pathname; 
    s.t();
    return true;
}
...
OmnitureSendPageLoad();

<!-- //////// END AZCENTRAL.COM OMNITURE CODE //////// -->